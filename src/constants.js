...
export const DUAL_CANNON_THRESHOLD = 350;  // was 500 — reach it faster
export const HOMING_THRESHOLD = 700;       // was 800
...
export const RIG_RECAPTURE_INTERVAL = 25;  // was 30 — more rig pressure
...
/* ===== NIGHT CYCLE ===== */
export const NIGHT_CYCLE_INTERVAL = 120;   // seconds before first night — players see it sooner
export const NIGHT_DURATION = 15;
...
export const RIG_SPAWN_INTERVAL = 90;    // seconds between new rig appearances (lower = fewer rigs)
